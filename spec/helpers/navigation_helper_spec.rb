...
RSpec.describe NavigationHelper, :type => :helper do 
  ...
  context 'signed in user' do
    ...
    context '#collapsible_links_partial_path' do
      it "returns collapsible_links_partial's path" do
  ...
  context 'not-signed in user' do
    ...
    context '#collapsible_links_partial_path' do
      it "returns collapsible_links_partial's path" do
        expect(helper.collapsible_links_partial_path).to (
          eq 'layouts/navigation/collapsible_elements/not_signed_in_links'
        )
      end
    end
  end
  ...
  context '#nav_header_content_partials' do
    ...
    it "returns partial's paths for buttons without dropdowns" do
    ...
    it "returns partial's paths for buttons and dropdowns" do
      controller.params[:controller] = 'not_messengers'
