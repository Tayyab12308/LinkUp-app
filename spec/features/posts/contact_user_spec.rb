...
RSpec.feature "Contact user", :type => :feature do
  ...
  context 'logged in user' do
    ...
    scenario 'sees an already contacted user message' do
  ...
  context 'non-logged in user' do
    scenario 'sees a login requireed message to contact a user' do
      visit post_path(post)
      expect(page).to have_selector('div', text: 'To contact the user you must')
    end
  end
end